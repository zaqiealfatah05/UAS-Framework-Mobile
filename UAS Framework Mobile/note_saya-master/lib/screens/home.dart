...
import 'package:note_saya/components/faderoute.dart';
import 'package:note_saya/data/models.dart';
import 'package:note_saya/screens/edit.dart';
import 'package:note_saya/screens/view.dart';
import 'package:note_saya/services/database.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text('tambah note'.toUpperCase()),
        icon: Icon(Icons.add),
      ),
  ...
  Widget buildImportantIndicatorText() w{
    return AnimatedCrossFade(
      duration: Duration(milliseconds: 200),
      firstChild: Padding(
        padding: const EdgeInsets.only(top: 8),
        child: Text(
          'Hanya menampilkan Note penting!'.toUpperCase(),
          style: TextStyle(
